...
class UserServiceImplTest {
    ...
    void register_shouldRegisterUserSuccessfully() {
        ...
        Mockito.when(userDao.register(Mockito.any(User.class))).thenReturn(user);
        ...
        Mockito.when(verificationTokenService.generateVerificationToken(Mockito.any(User.class))).thenReturn(token);
    ...
    void update_shouldUpdateUserSuccessfully() {
        ...
        Mockito.when(userDao.update(Mockito.any(User.class))).thenAnswer(i -> i.getArgument(0));
