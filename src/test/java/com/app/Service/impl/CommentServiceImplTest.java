...
class CommentServiceImplTest {
    ...
    void save_shouldSavedCommentSuccessfully() {
        ...
        Mockito.when(commentDao.save(Mockito.argThat( c ->
                c.getContent() != null &&
        ...
        Mockito.verify(commentDao).save(Mockito.argThat(c ->
                c.getContent() != null &&
                !c.getHashtags().isEmpty() &&
                c.getUserId() != 0 &&
                c.getPinId() != 0)
    ...
    void update_shouldUpdateComment_whenValidRequestAndMatchUser() {
        ...
        try (
            ...
            Mockito.when(commentDao.update(Mockito.eq(1L), Mockito.argThat(c ->
                    c.getContent() != null &&
                    !c.getHashtags().isEmpty() &&
                    c.getUserId() != 0 &&
                    c.getPinId() != 0)
            ...
            Mockito.verify(commentDao).update(Mockito.eq(1L), Mockito.argThat(c ->
                    c.getContent() != null &&
                    !c.getHashtags().isEmpty() &&
                    c.getUserId() != 0 &&
                    c.getPinId() != 0)
