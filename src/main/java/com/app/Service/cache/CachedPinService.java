...
public class CachedPinService extends CachedServiceHelper<Pin> implements PinService {
    ...
    public List<Pin> getAllPins(SortType sortType, int limit, int offset) {
        ...
        return super.getListOrLoad(redisKey, () -> delegate.getAllPins(sortType, limit, offset), limit, offset, Duration.ofHours(2));
    }
    ...
    public List<Pin> getAllPinsByHashtag(String tag, int limit, int offset) {
        ...
        return super.getListOrLoad(redisKey, () -> delegate.getAllPinsByHashtag(tag, limit, offset), limit, offset, Duration.ofHours(2));
    }
    ...
    public Pin findById(Long id, boolean fetchDetails) {
        ...
        var cached = super.getOrLoad(cacheKey, () -> delegate.findById(id, fetchDetails), Duration.ofHours(2));
    ...
    public List<Pin> findPinByUserId(Long userId, int limit, int offset) {
        ...
        return super.getListOrLoad(redisKey, () -> delegate.findPinByUserId(userId, limit,offset), limit, offset, Duration.ofHours(2));
    }
