...
public class CachedCommentService extends CachedServiceHelper<Comment> implements CommentService {
    ...
    public CachedCommentService(RedisTemplate<String, Comment> commentRedisTemplate, @Qualifier("commentServiceImpl") CommentService commentService) {
    ...
    public Comment findById(Long id, boolean fetchDetails) {
        ...
        var cached = super.getOrLoad(cacheKey, () -> commentService.findById(id, fetchDetails), Duration.ofHours(2));
        return cached.orElseThrow(() -> new CommentNotFoundException("Comment not found with a id: " + id));
    }
    ...
    public List<Comment> findByPinId(Long pinId, SortType sortType, int limit, int offset) {
        ...
        return super.getListOrLoad(redisKeys, () -> commentService.findByPinId(pinId, sortType, limit, offset), limit, offset, Duration.ofHours(2));
    }
    ...
    public List<Comment> findByHashtag(String tag, int limit, int offset) {
        ...
        return super.getListOrLoad(redisKeys, () -> commentService.findByHashtag(tag, limit, offset), limit, offset, Duration.ofHours(2));
    }
