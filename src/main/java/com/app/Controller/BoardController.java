...
public class BoardController {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "201",
            description = "Successfully create new board",
            content =
                @Content(
  ...
  public ResponseEntity<BoardResponse> addPinToBoard(
      @PathVariable Long boardId, @PathVariable Long pinId) {
  ...
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Successfully fetch board",
            content =
                @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = Board.class))),
  ...
  public ResponseEntity<BoardResponse> findById(
      @Parameter(description = "Id of the board to be search", required = true) @PathVariable
          Long id) {
  ...
  @ApiResponses(
      value = {@ApiResponse(responseCode = "204", description = "Successfully delete an comment")})
  @DeleteMapping("/{id}")
