...
public class KafkaConsumerConfig {
    ...
    private ConcurrentKafkaListenerContainerFactory<String, Object> createListenerContainerFactory(ConsumerFactory<String, Object> consumerFactory) {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> emailKafkaListenerContainerFactory() {
        return createListenerContainerFactory(createConsumerFactory("email-group", VerificationEmailEventDeserializer.class));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Object> notificationKafkaListenerContainerFactory() {
        return createListenerContainerFactory(createConsumerFactory("notification-group", NotificationEventDeserializer.class));
    }
}
